...
h5 = quiver3(0,0,0, X2(1), X2(2), X2(3), 'Color', 'black', 'LineWidth', 3, 'AutoScale','off');
h6 = text(X2(1), X2(2), X2(3),Label3DVector(X2));
...
pause; % span X2 space ... Smarter Ways?
h9 = plot3([3, -1], [-1.5, 0.5], [6, -2], ':', 'LineWidth', 3);
...
pause; % add X1
h10 = quiver3(0,0,0, X1(1), X1(2), X1(3), 'Color', 'black', 'LineWidth', 3, 'AutoScale','off');
h11 = text(X1(1), X1(2), X1(3),Label3DVector(X1));
